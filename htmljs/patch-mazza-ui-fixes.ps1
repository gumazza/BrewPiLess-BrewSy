...
$NavMenuCss = '[navigation] [menuToggle] .options{z-index:1001!important}[navigation] [menuToggle] .options a,[navigation] [menuToggle] .options a:link,[navigation] [menuToggle] .options a:visited{color:#eaeaea!important;-webkit-text-fill-color:#eaeaea!important}[navigation] [menuToggle] .options a.active{color:#e8a838!important;-webkit-text-fill-color:#e8a838!important}@media (max-width:700px){[navigation] [menuToggle] .options{background:#1a1a2e!important;transform:translate(100%,0)!important;opacity:0!important;pointer-events:none!important}[navigation] [menuToggle] input:checked~.options{transform:translate(0,0)!important;opacity:1!important;pointer-events:auto!important}}'
$GlobalFixCss = '.rssi-bar{background-color:#90ee90!important}' + $FormInputCss + $LogCss + $ModalCss + $ProfileCss + $NavMenuCss
